						...
						<ul class="thumbnails listing-products">
							<li class="span3">
								<div class="product-box">
                                    ...
                                    {{ HTML::image('image/themes/gambar/4.jpg') }}	
                                    </a><br/>
									<a href="product_detail.html" class="title">Black Hexagonal Monjali</a><br/>
							...
							<li class="span3">
								<div class="product-box">												
									<a href="product_detail.html">
                                    {{ HTML::image('image/themes/gambar/7.jpg') }}
                                    </a><br/>
							...
							<li class="span3">
								<div class="product-box">
									<span class="sale_tag"></span>												
									<a href="product_detail.html">
                                    {{ HTML::image('image/themes/gambar/10.jpg') }}
                                    </a><br/>
									<a href="product_detail.html" class="title">Black Hexagonal Monjali</a><br/>
									<p class="price">Rp500.000,-</p>
								</div>
							...
							<li class="span3">
								<div class="product-box">												
									...
									<a href="product_detail.html" class="title">Classic Black Cowhide Leather</a><br/>
									<p class="price">Rp700.000,-</p>
								</div>
							</li>
							<li class="span3">
								<div class="product-box">                                        												
							...
							<li class="span3">
								<div class="product-box">												
									<a href="product_detail.html">
                                    {{ HTML::image('image/themes/gambar/16.jpg') }}
                                    </a><br/>
							...
							<li class="span3">
								<div class="product-box">												
									<a href="product_detail.html">
                                    {{ HTML::image('image/themes/gambar/19.jpg') }}
                                    </a><br/>
